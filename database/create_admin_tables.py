"""
Скрипт для выполнения SQL-схемы админ-панели.
Выполняет SQL-запросы из файла admin_panel_schema.sql
"""
...
if __name__ == "__main__":
    ...
    sql_file = os.path.join(script_dir, "admin_panel_schema.sql")
